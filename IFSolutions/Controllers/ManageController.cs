...
namespace IFSolutions.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult AttributeRole()
        {
        ...
        public ActionResult RemoveRole(string RoleName)
        {
            ...
            {
                ViewBag.StatusMessage = "Error removing role";
            }
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.CommentsCount = currentUser.Comments.Count;
            ViewBag.SignaturesCount = currentUser.Signatures.Count;
